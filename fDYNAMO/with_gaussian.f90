subroutine chrg_server( code, natm, naqm, atmn, cord, ener, qfit, grad, hess )
	...
	integer :: system, i, j, k, l, n3, nh, ierr
	real*8 :: smm
	...
	write( 999, "(a/a/a)" ) "%Chk=calc", &
		"%Mem=100GB", &
		"#t {method}/{basis} charge guess=(read,tcheck) nosymm {otherOptions}"
	if( code == 1 ) then
	...
	write( 999, "(a//2i4)" ) "- slave -", {charge}, {multiplicity}
	do i = 1, naqm
		j = ( i - 1 ) * 3
	...
	i = system( "g16 calc.com" )
	i = system( "bash keep_log" )
